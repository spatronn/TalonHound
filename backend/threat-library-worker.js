...
import { getThreatLibraryQueueName } from './lib/threatLibrary/queueConfig.js';
import { runAnalysisPipeline } from './lib/threatLibrary/pipeline.js';
import { updateJob } from './lib/threatLibrary/store.js';
...
const worker = new Worker(
  ...
  async (job) => {
    ...
    log.info('job started', { bullmqJobId: job.id, reportId, jobId });

 ...
 * (users.is_system_admin = TRUE). The JWT does not carry the flag, so it is
 * resolved from the database by the internal user id. Machine/ingest principals
 * (no numeric id) are never system admins.

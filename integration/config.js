...
export const config = {
  ...
  certPlSourceName: process.env.CERTPL_SOURCE_NAME || 'CERT.PL:CERT-Polska',
  certPlDomainsUrl: process.env.CERTPL_DOMAINS_URL || 'https://hole.cert.pl/domains/v2/domains.json',
  certPlTimeoutMs: Number(process.env.CERTPL_TIMEOUT_MS || 60_000),
  certPlMaxRetries: Number(process.env.CERTPL_MAX_RETRIES || 3)
};
